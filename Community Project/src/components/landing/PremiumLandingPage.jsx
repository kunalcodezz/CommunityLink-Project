      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <motion.header
          ...
          style={{
            ...
            boxShadow: isScrolled ? '0 10px 30px rgba(15, 23, 42, 0.04)' : 'none',
            padding: '1rem 2rem'
          }}
        >
          <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            >
              <img 
                ...
                style={{ height: '42px', width: 'auto', borderRadius: '12px', boxShadow: '0 4px 12px rgba(37, 99, 235, 0.2)' }}
              />
            ...
            <nav style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
              {[
                ...
                { label: 'Missions', tab: 'explore' },
                { label: 'Communities', tab: 'feed' },
                { label: 'Impact Map', tab: 'map' },
